...
export default function Home() {
  return (
      <main className="bg-gray-100 h-screen flex items-center p-5 dark:bg-gray-700">
    <div className="bg-white shadow-lg w-full p-5 rounded-3xl max-w-screen-sm dark:bg-gray-600">
      ...
      <div className="my-2 flex items-center gap-2">
        <span className="bg-green-400 text-white uppercase px-2.5 py-1.5 text-xs font-medium
        rounded-full transition hover:bg-green-500 hover:scale-110">
          Today
        </span>
